...
import com.political.ocr.Helper.SQLiteDatabaseHelper;
import com.political.ocr.Helper.Saver;
...
public class Operation {
    ...
    private void writeToFile(String data, int id) {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            FileWriter out = null;
            try {
                out = new FileWriter(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS), title + ".txt"));
            } catch (IOException e) {
                e.printStackTrace();
            }
            try {
